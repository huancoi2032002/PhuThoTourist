...
function initSwiper(_ref, swiperParams) {
  var el = _ref.el, nextEl = _ref.nextEl, prevEl = _ref.prevEl, paginationEl = _ref.paginationEl, scrollbarEl = _ref.scrollbarEl;
  ...
  return new core_class_default(el, swiperParams);
}
...
function getChildren(children) {
  ...
  function processChildren(c) {
    import_react2.default.Children.toArray(c).forEach(function(child) {
      if (child.type === import_react2.default.Fragment && child.props.children) {
...
var Swiper = (0, import_react5.forwardRef)(function(_temp, externalElRef) {
  var _ref = _temp === void 0 ? {} : _temp, className = _ref.className, _ref$tag = _ref.tag, Tag = _ref$tag === void 0 ? "div" : _ref$tag, _ref$wrapperTag = _ref.wrapperTag, WrapperTag = _ref$wrapperTag === void 0 ? "div" : _ref$wrapperTag, children = _ref.children, onSwiper = _ref.onSwiper, rest = _objectWithoutPropertiesLoose(_ref, ["className", "tag", "wrapperTag", "children", "onSwiper"]);
  ...
  var _getParams = getParams(rest), swiperParams = _getParams.params, passedParams = _getParams.passedParams, restProps = _getParams.rest;
