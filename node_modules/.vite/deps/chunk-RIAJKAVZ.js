  ...
  if (speed === 0) {
    ...
    if (!swiper.animating) {
      ...
      if (!swiper.onTranslateToWrapperTransitionEnd) {
        swiper.onTranslateToWrapperTransitionEnd = function transitionEnd7(e) {
  ...
  if (speed === 0) {
    ...
    if (!swiper.animating) {
      ...
      if (!swiper.onSlideToWrapperTransitionEnd) {
        swiper.onSlideToWrapperTransitionEnd = function transitionEnd7(e) {
          if (!swiper || swiper.destroyed) return;
          if (e.target !== this) return;
...
function onTouchStart(event2) {
  ...
  if (edgeSwipeDetection && (startX <= edgeSwipeThreshold || startX >= window2.screen.width - edgeSwipeThreshold)) {
    return;
  }
  extend2(data, {
    isTouched: true,
...
var virtual_default = {
  ...
  create: function create3() {
    var swiper = this;
    bindModuleMethods(swiper, {
      virtual: _extends2(_extends2({}, Virtual), {}, {
...
var a11y_default = {
  ...
  create: function create13() {
    var swiper = this;
    bindModuleMethods(swiper, {
      a11y: _extends11(_extends11({}, A11y), {}, {
...
var autoplay_default = {
  ...
  create: function create16() {
    var swiper = this;
    bindModuleMethods(swiper, {
      autoplay: _extends14(_extends14({}, Autoplay), {}, {
        running: false,
        paused: false
      })
    });
...
//# sourceMappingURL=chunk-RIAJKAVZ.js.map
