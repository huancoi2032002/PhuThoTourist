...
const DocumentCard:React.FC<TypeCard> = ({src, title}) => {
    return (
        <div className="xl:w-[177px] w-[102px] xl:h-[261px] h-[153px] flex-shrink-0 rounded-xl overflow-hidden custom-document-card relative cursor-pointer">
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[130px] h-[138px] flex px-1 flex-col justify-center items-center z-10">
                ...
                <span className="flex xl:h-[33.735px] h-[24px] justify-center items-center xl:text-sm text-[10px] text-[#FFF] text-center font-bold">{title}</span>
            </div>
